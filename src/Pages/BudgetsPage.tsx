...
export default function BudgetsPage() {
  ...
  const mockBudgets: Budget[] = [
    {
      ...
      spent: 25.00,
      latestTransactions: [
        { avatar: "0", name: 'Pine Cinema', date: '14 Aug 2024, 14:30', amount: -14.00, category: "budgets", recurring: false },
        // ... 其他交易
      ]
    },
    // ... 其他預算分類
  ...
  function handleAddNewBudgetModal() {
    setIsModalOpen(true)
  }
  ...
  return (
    <>
      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <button className="bg-gray-900 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-gray-800 transition-colors" onClick={handleAddNewBudgetModal}>
          + Add New Budget
        </button>
      </div>
